...
import com.mladen.studies.repository.ProfesorRepository;
...
public class ProfesorServiceImpl implements ProfesorService {
    ...
    public List<Profesor> dajProfesorePoImenu(String name) {
        return profesorRepository.findProfesorByImeContaining(name);
    }

    @Override
    public Profesor dajProfesoraPoImenu(String name) {
        return profesorRepository.findProfesorByImeEquals(name);
    }
